<script lang="ts">
	...
	import type { Exercise, Set } from '$lib/services/customTypes';
	import { SetType } from '$lib/services/customTypes';
	import ErrorCard from '$lib/components/ErrorCard.svelte';

	let workout = $page.data.workout;
	...
	async function editWorkoutTemplate() {
		const response = await fetch(`/training/template/${workout.id}/edit`, {
			method: 'PUT',
		...
		if (responseJSON.success) {
			goto(`/training/template/${workout.id}`);
		} else {
